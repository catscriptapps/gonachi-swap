        ...
        if (result.success) {
            ...
            result.pictures.forEach(pic => {
                ...
                const deleteBtnHtml = canManage ? `
                    <button type="button" data-action="delete-picture" data-id="${pic.entry_id || pic.pic_id || pic.id}" class="p-2 bg-red-500/80 hover:bg-red-500 rounded-full text-white transition-colors" title="Delete Photo">

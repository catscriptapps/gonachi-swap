    ...
    <div class="space-y-4">
        ...
        <div class="grid grid-cols-2 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <a href="<?= $baseUrl ?>chats"
                ...
                <div class="mt-8 relative z-10">
                    <h3 class="text-xl font-black text-secondary-900 dark:text-white">Chats</h3>
                    <div class="flex items-center gap-2 mt-1">
                        <span class="relative flex h-2 w-2">
                            <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary-400 opacity-75"></span>
                            <span class="relative inline-flex rounded-full h-2 w-2 bg-primary-500"></span>
                        </span>
                        <p class="text-[10px] text-gray-400 uppercase tracking-widest font-black">Internal Comms</p>
                    </div>
                </div>

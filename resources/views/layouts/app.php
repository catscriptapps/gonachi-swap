...
<body class="font-sans antialiased h-full text-gray-900 dark:text-gray-100 bg-gray-50 dark:bg-gray-950"
    ...
    <div
        ...
        <?php
        // The Modals for viewing listings, quotations, adverts, and notifications are included globally here to ensure they are available on all pages without needing to include them in each individual page file.
        include __DIR__ . '/../partials/image-preview-modal.php';
        include __DIR__ . '/../partials/search-modal.php';
        include __DIR__ . '/../components/adverts/view-advert-modal.php';

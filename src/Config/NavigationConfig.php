...
class NavigationConfig
{
    ...
    public static function getIcons(): array
    {
        return [
            ...
            'Home Buyers'           => '<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" /></svg>',
            'Home Sellers'          => '<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" /></svg>',
            'Groups'                => '<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>',
            'Blog Posts'            => '<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10l4 4v10a2 2 0 01-2 2zM7 8h4m-4 4h8m-8 4h8" /></svg>',
    ...
    public static function authLinks(bool $showAll = false): array
    {
        ...
        $allPossibleApps = [
            ...
            'Adverts'               => $base . '/adverts',
            'Quotations'            => $base . '/quotations',
            'Mentors'               => $base . '/mentors',
            'Listings'              => $base . '/listings',
            //'Tenant Validation'     => $base . '/tenant-validation',
            //'Protect Rentals'       => $base . '/protect-rentals',
            //'Evaluate Landlords'    => $base . '/evaluate-landlords',
            //'Ratings'               => $base . '/ratings',
            //'Recommendations'       => $base . '/recommendations',
            //'Home Buyers'           => $base . '/home-buyers',
            //'Home Sellers'          => $base . '/home-sellers',
            //'Groups'                => $base . '/groups',
            //'Blog Posts'            => $base . '/blog-posts',
    ...
    public static function getProtectedPaths(): array
    {
        ...
        // Adverts, Quotations, Listings, Blog Posts, Mentors, Social Feed excluded so guests can view them.
        return [
            $base . '/dashboard',
            //$base . '/tenant-validation',
            //$base . '/protect-rentals',
            //$base . '/evaluate-landlords',
            //$base . '/ratings',
